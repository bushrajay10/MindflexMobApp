            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    '"Row a Boat VR" immerses players in a realistic boating experience, allowing them to navigate picturesque waterways while mastering rowing techniques. The game combines beautiful visuals and realistic mechanics, creating a relaxing adventure on the water from the comfort of home.',
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.grey,
                    ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 20), // Space between heading and content
                  const Text(
                    '"Row a Boat VR" aids stroke patients by promoting upper body strength and coordination through rowing motions. The game encourages repetitive arm movements to enhance shoulder mobility and fine motor skills, making rehabilitation more enjoyable and engaging.',
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.grey,
                    ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const Expanded(
                        child: Text(
                          'Download and install Row A Boat Game',
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: Colors.grey,
